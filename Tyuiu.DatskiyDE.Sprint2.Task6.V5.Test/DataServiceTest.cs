...
namespace Tyuiu.DatskiyDE.Sprint2.Task6.V5.Test
{
    [TestClass]
    public class DataServiceTest
    {
        ...
        public void ValidFindCardName()
        {
            ...
            Assert.AreEqual("Неверный номер карты", ds.FindCardValue(5));
            Assert.AreEqual("Неверный номер карты", ds.FindCardValue(15));
        }
    }
}
